...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	<h1 class="h3 mb-0">Freshmen Applicant Profiles</h1>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<select class="form-select form-select-lg" id="academicYear">
					...
					$sql = "SELECT * FROM applicant_profiles GROUP BY academic_year";
	...
	$(document).ready( 
		function() {
			...
			$('#datatable').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url: `../../assets/api/admin/freshmen-applicant.inc.php?freshmenApplicantProfiles`,
					type: "POST",
					data: {
