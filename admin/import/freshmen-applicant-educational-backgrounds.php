...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	<h1 class="h3 mb-0">Import Applicants' Educational Backgrounds</h1>
...
<div class="row">
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="mb-0">
					...
					<li>Current Grade 12 School</li>
					<li>Current Grade 12 Graduation Year</li>
					<li>Grade 12 Gradaute School</li>
					<li>Grade 12 Gradaute Graduation Year</li>
					<li>HS Graduate School</li>
					<li>HS Graduate Graduation Year</li>
					<li>College Graduate, College School</li>
					<li>College Graduate, College Graduation Year</li>
					<li>College Graduate, HS/SHS School</li>
					<li>College Graduate, HS/SHS Graduation Year</li>
					<li>ALS Graduate Year Passed</li>
					<li>Date Applied</li>
				</ul>
			</div>
		</div>	
	...
	<div class="col-md-8">
		<form class="card" id="form" enctype="multipart/form-data">
			<div class="card-body">
				<div class="mb-3">
					<label>Applicants' Educational Backgrounds CSV</label>
...
<script type="text/javascript">
	$(document).ready(function() { 
		$('#form').submit(function(e) {	
			...
			formData.append("submitImportFreshmenApplicantEducationalBackgrounds", "");
