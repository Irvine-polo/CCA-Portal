...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	...
	<a class="btn btn-primary d-flex justify-content-between align-items-center" href="./faculty-student-grades?academicYear=<?= sanitize($_GET["academicYear"]); ?>&semester=<?= sanitize($_GET["semester"]); ?>">
	...
	<div class="card-body">
		...
		if (mysqli_num_rows($result) > 0) {
			while ($row = mysqli_fetch_assoc($result)) {
				array_push($coordinatorClasses, $row["class_code"]);
			}
		}

		if (in_array($classCode, $coordinatorClasses)) {
			$classDetails = "";
