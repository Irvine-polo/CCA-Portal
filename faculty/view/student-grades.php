...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	...
	<a class="btn btn-primary d-flex justify-content-between align-items-center" href="../student-grades">
	...
	$(document).ready( 
		function() {
			$('#datatable').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url: `../../assets/api/faculty/student-grade.inc.php?getClassRecords&academicYear=${academicYear}&semester=${semester}`,
					type: "POST"
				}
			});
		}
