									...
									<div class='col-12'>
										...
										<?php 	
											if ($exists < 2) {
												...
												echo '<a href="evaluation/index.php?eval_peer='.$evaluation_id.'" class="btn btn-info btn-sm">Evaluate Faculty</a>';
												}
										 ?>	
							...
							<div class='card-body'>
								...
								<div class="text-center">
									<div class='col-12'>
										...
										<?php 	
											if ($exists < 1) {
												echo '<a href="evaluation/index.php?eval_self='.$evaluation_id.'" class="btn btn-info btn-sm">Evaluate Faculty</a>';
												}
										 ?>	
										...
										<div class="text-center">
											<div class='col-12'>
												...
												<?php 	
													...
													if ($sql_response_complete < $facul_num) {
														echo '<a id="evaluation"href="evaluation/index.php?eval_head='.$evaluation_id.'" class="btn btn-info btn-sm">Evaluate Faculty</a>';
														}
												 ?>		
