		...
		<div class="card">
			<div class="card-body">
				...
				<div style="margin-top: 20px;" class="text-center">	
					...
					<a href="index.php?start-evaluation=true" class="btn btn-success">Start evaluation</a>
				</div>
			</div>
		</div>
...
<!--				<a href="index.php?start-evaluation=true" class="btn btn-success href">Start</a>-->
<!--			</div>-->
<!--		</div>-->
<!--	</div>-->
<!--</div>-->
