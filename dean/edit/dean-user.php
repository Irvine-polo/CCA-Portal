...
<div class="card">
    <form class="card-body" action="../../assets/includes/dean/dean-user.inc.php" method="POST">
                        ...
                        <div class='row'>
                            <div class='col-md-4'>
                                <div class='mb-3'>
                					...
                					<input class='form-control form-control-lg' type='text' name='institute' value='" . $row["institute"] . "' readonly>
                				</div>
                			</div>
