...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	<h1 class="h3 mb-0">View Class Schedules</h1>

	<a class="btn btn-primary d-flex justify-content-between align-items-center" href="../dean-class-schedules">
	...
	$(document).ready( 
		function() {
			$('#datatable').DataTable({
				...
				"serverSide": true,
				"ajax":{
					url: `../../assets/api/dean/dean-class-schedule.inc.php?getClassSchedules&academicYear=${academicYear}&semester=${semester}`,
					type: "POST"
				}
			});
		}
