...
<div class="d-flex justify-content-between align-items-center d-print-none mb-3">
	<h1 class="h3 mb-0">Import Class Schedules</h1>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="mb-0">
					...
					<li>Course Title</li>
					<li>Lecture Hours</li>
					<li>Laboratory Hours</li>
					<li>Units</li>
					<li>Synchronous Day</li>
					<li>Synchronous Time</li>
					<li>Asynchronous Day</li>
					<li>Asynchronous Time</li>
				</ul>
			</div>
		</div>	
	</div>
...
<script type="text/javascript">
	$(document).ready(function() { 
		$('#form').submit(function(e) {	
			...
			formData.append("submitImportClassSchedules", "");

			$.ajax({
				url: "../../assets/includes/dean/dean-class-schedule.inc.php",
				type: "POST",
				data: formData,
				dataType: "json",
				contentType: false,
