	...
	if (mysqli_num_rows($result) > 0) {
		while ($row = mysqli_fetch_assoc($result)) {
			...
			$subdata[] = "<div class='btn-group'>
				<a class='btn btn-success btn-sm' href='./import/student-grades?academicYear=" . $academicYear . "&semester=" . $semester . "'>
					<i class='fa-solid fa-upload'></i>
				</a>
				<a class='btn btn-info btn-sm' href='./view/student-grades?academicYear=" . $academicYear . "&semester=" . $semester . "'>
