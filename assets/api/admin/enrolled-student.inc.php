		...
		while ($row = mysqli_fetch_assoc($result)) {
			...
			if ($row["is_active"] == 1) {
				$subdata[] = "<div class='btn-group'>
					<a class='btn btn-success btn-sm' href='./import/enrolled-students?academicYear=" . $academicYear . "&semester=" . $semester . "' title='import/reimport'>
						<i class='fa-solid fa-upload'></i>
					</a>
					<a class='btn btn-primary btn-sm' href='./add/enrolled-student?academicYear=" . $academicYear . "&semester=" . $semester . "' title='add'>
