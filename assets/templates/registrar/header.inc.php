...
<head>
	...
	<meta name="author" content="Jimwel & Irvine">
	...
	<div class="wrapper">
		<nav class="sidebar js-sidebar user-select-none" id="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand d-flex flex-column align-items-center text-center" href="<?= $baseUrl; ?>registrar">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item <?= page("dashboard", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar">
					...
					<li class="sidebar-item <?= page("users", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/users">
					...
					<li class="sidebar-item <?= page("academicYears", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/academic-years">
					...
					<li class="sidebar-item <?= page("enrolledStudents", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/enrolled-students">
					...
					<li class="sidebar-item <?= page("studentGrades", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/student-grades">
					...
					<li class="sidebar-item <?= page("reportCards", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/report-cards">
					...
					<li class="sidebar-item <?= page("honorStudents", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>registrar/honor-students">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="<?= $baseUrl; ?>registrar/profile">
