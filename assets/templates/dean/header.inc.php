	...
	<div class="wrapper">
		<nav class="sidebar js-sidebar user-select-none d-print-none" id="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand d-flex flex-column align-items-center text-center" href="<?= $baseUrl; ?>dean">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?= page("facultyClassSchedules", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean">
					...
					<li class="sidebar-item <?= page("facultyStudentGrades", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/faculty-student-grades">
					...
					<li class="sidebar-item <?= page("evaluation-tab", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/evaluation-tab">
							<i class="fa-solid fa-chart-pie align-middle"></i>
							<span class="align-middle">Evaluate Faculty</span>
						</a>
					</li>

					<li class="sidebar-header">Dean</li>

					<li class="sidebar-item <?= page("deanUsers", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/dean-users">
							<i class="fa-solid fa-users align-middle"></i>
							<span class="align-middle">Users</span>
						</a>
					</li>

					<li class="sidebar-item <?= page("deanClassSchedules", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/dean-class-schedules">
							<i class="fa-solid fa-calendar-days align-middle"></i>
							<span class="align-middle">Class Schedules</span>
						</a>
					</li>

					<li class="sidebar-item <?= page("deanStudentGrades", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/dean-student-grades">
							<i class="fa-solid fa-star align-middle"></i>
							<span class="align-middle">Student Grades</span>
						</a>
					</li>
					...
					<li class="sidebar-item <?= page("evaluations", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>dean/evaluation/">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
								...
								<div class="list-group">
									...
									if (mysqli_num_rows($result) > 0) {
										while ($row = mysqli_fetch_assoc($result)) {
											if ($row["has_seen"] == 0) {
												echo "<a href='" . $baseUrl . "assets/includes/dean/notification.inc.php?viewNotification&notificationId=" . $row["id"] . "' class='list-group-item fw-bold'>
												...
												echo "<a href='" . $baseUrl . "assets/includes/dean/notification.inc.php?viewNotification&notificationId=" . $row["id"] . "' class='list-group-item'>
													<div class='row g-0 align-items-center'>
														<div class='col-2'>
															<i class='text-primary' data-feather='bell'></i>
														</div>
								...
								<div class="dropdown-menu-footer">
									<a href="<?= $baseUrl; ?>dean/view/notifications" class="text-muted">Show all notifications</a>
								</div>
							</div>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="<?= $baseUrl; ?>dean/profile">
