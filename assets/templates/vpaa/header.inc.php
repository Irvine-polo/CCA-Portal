	...
	<div class="wrapper">
		<nav class="sidebar js-sidebar user-select-none d-print-none" id="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand d-flex flex-column align-items-center text-center" href="<?= $baseUrl; ?>vpaa">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item <?= page("dashboard", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>vpaa">
					...
					<li class="sidebar-item <?= page("evaluation-tab", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>vpaa/evaluation-tab">
							<i class="fa-solid fa-chart-pie align-middle"></i>
					...
					<li class="sidebar-header">Vpaa</li>

					<li class="sidebar-item <?= page("evaluations", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>vpaa/evaluation/">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
								...
								<div class="list-group">
									...
									if (mysqli_num_rows($result) > 0) {
										while ($row = mysqli_fetch_assoc($result)) {
											if ($row["has_seen"] == 0) {
												echo "<a href='" . $baseUrl . "assets/includes/vpaa/notification.inc.php?viewNotification&notificationId=" . $row["id"] . "' class='list-group-item fw-bold'>
												...
												echo "<a href='" . $baseUrl . "assets/includes/vpaa/notification.inc.php?viewNotification&notificationId=" . $row["id"] . "' class='list-group-item'>
													<div class='row g-0 align-items-center'>
														<div class='col-2'>
															<i class='text-primary' data-feather='bell'></i>
														</div>
								...
								<div class="dropdown-menu-footer">
									<a href="<?= $baseUrl; ?>vpaa/view/notifications" class="text-muted">Show all notifications</a>
								</div>
							</div>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="<?= $baseUrl; ?>vpaa/profile">
