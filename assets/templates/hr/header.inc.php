	...
	<div class="wrapper">
		<nav class="sidebar js-sidebar user-select-none d-print-none" id="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand d-flex flex-column align-items-center text-center" href="<?= $baseUrl; ?>hr">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item <?= page("evaluation", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>hr/">
							<i class="fa-solid fa-chart-pie align-middle"></i>
							<span class="align-middle">Faculty Evaluation</span>
						</a>
					</li>

					<li class="sidebar-item <?= page("evaluations_report", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>hr/eval/evaluation/">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="<?= $baseUrl; ?>hr/profile">
