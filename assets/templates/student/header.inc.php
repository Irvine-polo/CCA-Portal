	...
	<div class="wrapper">
		<nav class="sidebar js-sidebar user-select-none" id="sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand d-flex flex-column align-items-center text-center" href="<?= $baseUrl; ?>student">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item <?= page("classSchedules", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>student">
							<i class="fa-solid fa-calendar-week align-middle"></i>
							<span class="align-middle">Class Schedules</span>
						</a>
					</li>

					<!-- <li class="sidebar-item <?= page("currentGrades", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>student/current-grades">
							<i class="fa-solid fa-ranking-star align-middle"></i>
							<span class="align-middle">Current Grades</span>
						</a>
					</li> -->

					<li class="sidebar-item <?= page("certificateOfRegistration", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>student/certificate-of-registration">
					...
					<li class="sidebar-item <?= page("reportCards", $page); ?>">
						<a class="sidebar-link" href="<?= $baseUrl; ?>student/report-cards">
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="<?= $baseUrl; ?>student/profile">
