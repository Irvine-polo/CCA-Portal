...
if (isset($_GET["activateAcademicYear"])) {
	...
	if (!mysqli_query($conn, $sql)) {
		header("Location: " . $baseUrl . "admin/academic-years?error=Activate Academic Year error");
		exit();
	}
	...
	header("Location: " . $baseUrl . "admin/academic-years?success=Activated Academic Year successfully");
	exit();
}