...
if (isset($_GET["getReportCards"])) {
	...
	if ($academicYearFull == "no class recored available") {
        echo "<div class='card cca-card'>
    		<div class='card-body text-center'>
    			No Class Records to show
    		</div>
    	</div>";
	} else {
	    if ($academicYearFull != "") {
    ...
    ORDER BY CONCAT(student_grades.academic_year, ' ', student_grades.semester) ASC";
    									...
    									if (mysqli_num_rows($result3) > 0) {
    									   ...
    									   echo "<tr>
        										...
        										while ($row3 = mysqli_fetch_assoc($result3)) {
        										    $classCode = $row3["class_code"];
        										    
        										    $sql4 = "SELECT * FROM class_schedules WHERE academic_year = '$academic_year' AND semester = '$semester' AND class_code = '$classCode' AND status = 'finalized'";
    			...
    			echo "<div class='card cca-card'>
    				<div class='card-body'>
    					<div class='text-center'>
    						...
    						<h6 class='fw-bold mb-0'>REPORT CARD</h6>
    						<h6 class='fw-bold small mb-3'>All Semesters</h6>
    					</div>
