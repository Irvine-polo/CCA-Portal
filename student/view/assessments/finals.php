		...
		<div class="card">
			<div class="card-body">
				<div class="list-group">
					...
					<a class='list-group-item list-group-item-action active' href='./finals?classCode=" . $classCode . "&subjectCode=" . $subjectCode . "'>Finals</a>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered table-border-dark table-striped table-sm text-center w-100">
						<thead>
							<tr>
								<th class="bg-gray-100" colspan="100%">Seatworks</th>
							</tr>
							<tr>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-border-dark table-striped table-sm text-center w-100">
						<thead>
							<tr>
								<th class="bg-gray-100" colspan="100%">Quizzes</th>
							</tr>
							<tr>
								<th width="10%">Total</th>
								<th>20</th>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-border-dark table-striped table-sm text-center w-100">
						<thead>
							<tr>
								<th class="bg-gray-100" colspan="100%">Major Examination</th>
							</tr>
							<tr>
								<th width="10%">Total</th>
								<th>50</th>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-border-dark table-striped table-sm text-center w-100 mb-0">
						<thead>
							<tr>
								<th class="bg-gray-100" colspan="100%">Final Grade</th>
							</tr>
							<tr>
