...
<div class="card">
    <form class="card-body" action="../../assets/includes/registrar/user.inc.php" method="POST">
                    ...
                    <div class='col-md-6'>
                        <div class='row'>
                			...
                			<div class='col-md-6'>
                                <div class='mb-3'>
                					<label>Role</label>
                					<input class='form-control form-control-lg' type='text' name='role' value='" . $row["role"] . "' readonly>
                				</div>
                			</div>
                		</div>
