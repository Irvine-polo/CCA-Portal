...
<script type="text/javascript">
	$.ajax({
		type: "GET",
		url: "../assets/includes/registrar/report-card.inc.php?getStudentNumbers&academicYearFull=" + $("#academicYearFull").val(),
		dataType: "html",
		beforeSend: function () {
		...
		success: function(data){
			...
			$.ajax({
				type: "GET",
				url: "../assets/includes/registrar/report-card.inc.php?getReportCards&academicYearFull=" + $("#academicYearFull").val() + "&studentNumberSelect=" + $("#studentNumberSelect").val() + "&studentNumberInput=" + $("#studentNumberInput").val(),
				dataType: "html",
				beforeSend: function () {
					$("#academicYearFull").prop("disabled", true);
					$("#studentNumberSelect").prop("disabled", true);
