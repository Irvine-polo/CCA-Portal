...
<script type="text/javascript">
	$.ajax({
		type: "GET",
		url: "../assets/includes/registrar/honor-student.inc.php?getCourses&academicYearFull=" + $("#academicYearFull").val(),
		dataType: "html",
		beforeSend: function () {
		...
		success: function(data){
			...
			$.ajax({
				type: "GET",
				url: "../assets/includes/registrar/honor-student.inc.php?getHonorStudents&academicYearFull=" + $("#academicYearFull").val() + "&course=" + $("#coursesSelect").val() + "&sortHonorStudentsSelect=" + $("#sortHonorStudentsSelect").val(),
				dataType: "html",
				beforeSend: function () {
					$("#academicYearFull").prop("disabled", true);
					$("#coursesSelect").prop("disabled", true);
